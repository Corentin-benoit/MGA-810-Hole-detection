...
namespace Application_Fusion260_V2.Holes.HoleWizard
{
    internal class WizardHole_Tapped_Hole : WizardHole
    {
        protected string fastenerSize;
        protected new int fastenerType;
        protected double tapDrillDiameter;

        public WizardHole_Tapped_Hole(double depth, double diameter, int id,
                                        string functionHoleCreation,
                                        List<Face2> holeFaces,
                                        int norm, int fastenerType, string fastenerSize, double tapDrillDiameter)
                                        : base(depth, diameter, id, functionHoleCreation, holeFaces, norm, fastenerType)
        {
            ...
            this.tapDrillDiameter = tapDrillDiameter;
        }
        /*
        * Assessors
        */
        ...
        public string ass_TapDrillDiameter
        {
            get { return this.fastenerSize; }
            set { this.fastenerSize = value; }
        }
